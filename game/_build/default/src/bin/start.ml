...
let draw_square _ = draw_rect 20 20 360 360
...
let mouth = [ (40, 100); (70, 80); (350, 80); (380, 100) ] |> Array.of_list
let tongue = [ (250, 79); (250, 30); (300, 30); (300, 79) ] |> Array.of_list
let left_eye = [ (60, 260); (100, 260); (100, 300); (60, 300) ] |> Array.of_list
let left_iris = [ (70, 260); (90, 260); (90, 280); (70, 280) ] |> Array.of_list
...
let nose = [ (160, 150); (240, 150); (240, 210); (160, 210) ] |> Array.of_list
